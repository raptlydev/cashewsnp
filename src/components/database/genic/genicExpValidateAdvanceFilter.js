...
import { getGenicExpData, updateDatabaseData } from "../../../redux/actions/database";
...
class GenicExpValidateAdvanceFilter extends Component {
	constructor(props) {
		super(props);
	...
	applyFilter = () => {
		...
		this.props.getGenicExpData(obj).then(() => {
...
const WrappedDynamicRule = Form.create({ name: 'advance_filter' })(GenicExpValidateAdvanceFilter);
